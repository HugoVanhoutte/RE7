...
<div class="container">
    <div>
        ...
        <h3>Recette Créée par <strong><a href="../../public/index.php/user?action=profile&id=<?= $author->getId() ?>"><?= $author->getUsername() ?></a></strong>
    ...
    <div>
        <div class="row justify-content-center">
            <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-6 col-xxl-4">
                <h2>Commentaires: </h2>

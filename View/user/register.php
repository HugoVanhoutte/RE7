        ...
        <div class="col col-md-4 shadow rounded bg-light text-center">
            <form action="/index.php/user?action=validateRegistration" method="post" class="needs-validation" novalidate>
                ...
                <div class="my-2">
                    ...
                    <div class="input-group has-validation"><span class="input-group-text"><i class="fa-solid fa-user"></i></span>
                ...
                <div class="my-2">
                    ...
                    <div class="row justify-content-evenly mt-2">
                        <div class="col-1 border rounded bg-danger text-light" id="password-validation-length" title="Votre mot de passe doit contenir au minimum 8 caractères">8</div>
